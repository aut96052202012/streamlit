...
/**
 * Class representing a Lighthouse Runner. This class is responsible for
 * managing the lifecycle of a headless Chrome instance and a Streamlit
 * application, and running Lighthouse audits on the Streamlit application.
 */
export class LighthouseRunner {
  ...
  /**
   * Initialize the LighthouseRunner by launching a headless Chrome instance.
  ...
  /**
   * Destroy the LighthouseRunner by stopping the Chrome and Streamlit
   * processes.
   * @returns {Promise<void>}
   */
  async destroy() {
